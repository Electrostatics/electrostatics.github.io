...
<ul>
<ol>From the PDB2PQR server web page, enter 1HPX into the PDB ID field.</ol>
<ol>Choose whichever forcefield and naming schemes you prefer.</ol>
<ol>Under options, be sure the "Ensure that new atoms are not rebuilt too close to existing atoms", "Optimize the hydrogen bonding network", and "Use PROPKA to assign protonation states at pH" options are selected. Choose pH 7 for your initial calculations. You can select other options as well, if interested.</ol>
<ol>Hit the "Submit" button.</ol>
</ul>
